<div class="w-64 bg-white shadow-lg border-r border-gray-100 min-h-screen flex flex-col">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
        <a href="{{ route('home') }}" class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700">🏠
            Dashboard</a>
        <a href="{{ route('tasks.index') }}" class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700">✅
            Tasks</a>
        @role('admin|director')
        ...
        <div x-data="{ open: false }" class="space-y-1">
            ...
            <div x-show="open" x-cloak x-collapse class="pl-4 space-y-1">
                ...
                <a href="{{ route('users.create') }}"
                    class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700">➕ Create User</a>
                <a href="{{ route('admin.roles.index') }}"
                    class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700">👤 Roles </a>
                <a href="{{ route('admin.permissions.index') }}"
                    class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700">👤 Permissions </a>
        ...
        <div x-data="{ open: false }" class="space-y-1">
            ...
            <div x-show="open" x-cloak x-collapse class="pl-4 space-y-1">
                <a href="{{ route('projects.create') }}"
                    class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700"> + New Project</a>
                {{-- <a href="{{ route('projects.create') }}"
                    class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700"> + Deliverables Mgt</a>
                <a href="{{ route('projects.create') }}"
                    class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700"> + Project Overview</a>
                <a href="{{ route('projects.create') }}"
                    class="block px-3 py-2 rounded-lg hover:bg-blue-50 hover:text-blue-700"> + Analytics</a> --}}
            </div>
